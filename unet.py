...
from U_Net_512_512.data import dataProcess
import numpy as np
...
class myUnet(object):
    ...
    def train(self):
        ...
        print('Fitting model...')
        model.fit(imgs_train, imgs_mask_train, batch_size=1, epochs=1, verbose=1, shuffle=True, callbacks=[model_checkpoint])
